  ...
  return (
    ...
    >
      ...
      <p className='text-[20px] lg:text-2xl leading-[1.6] lg:leading-[40px] tracking-wide'>
        ...
        keen eye for detail, I'm on a mission to turn ideas into interactive
        realities. Join me on this coding adventure where each line is a
        brushstroke, and every project is a captivating masterpiece in the
        digital realm.
      </p>
      <h2
        className={
